...
export default function HomePage() {
  ...
  return <main>
    ...
    <section className="contact section" id="contato"><div className="contact-copy"><p className="kicker light">O primeiro contato pode ser pelo WhatsApp</p><h2>Talvez seja hora de falar sobre isso.</h2><p>Nem sempre é fácil saber quando procurar psicoterapia. Se existe algo que vem se repetindo ou tornando a vida mais difícil, podemos conversar sobre a possibilidade de um atendimento.</p><a className="button button-light" href={whatsapp} target="_blank" rel="noreferrer">Agendar atendimento <span>↗</span></a><p className="contact-hours">Atendimento mediante agendamento prévio</p></div><div className="contact-actions" aria-label="Contato e localização"><a className="contact-action-card" href={whatsapp} target="_blank" rel="noreferrer"><span className="contact-action-number">01</span><small>Fale diretamente</small><strong>WhatsApp</strong><p>Inicie uma conversa com a Patrícia.</p><b>Abrir conversa ↗</b></a><a className="contact-action-card" href="https://www.instagram.com/psicopatriciarocha/" target="_blank" rel="noreferrer"><span className="contact-action-number">02</span><small>Acompanhe</small><strong>Instagram</strong><p>@psicopatriciarocha</p><b>Visitar perfil ↗</b></a><button className="contact-action-card contact-location-button" type="button" onClick={() => setShowDirections(true)}><span className="contact-action-number">03</span><small>Consultório</small><strong>Como chegar</strong><p>Rua Barão do Triunfo, 720 · sala 308<br/>Menino Deus · Porto Alegre/RS</p><b>Escolher Maps ou Waze →</b></button></div></section>
